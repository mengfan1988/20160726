<?php if (!defined('THINK_PATH')) exit();?>
    <div class="col-lg-3"></div>
     <div class="col-lg-6" >
         <form class='cl' id='useradd' method="post" >
            ...
            <div class="form-group row">             
                <button type="button" class="btn btn-primary btn-lg" id='submit'>添加</button>
            </div>
         </form>
    </div>
    <div class="col-lg-3"></div>
           ...
           $("#useradd").validate({
			rules: {
				aname: {
					...
					minlength: 2,
                                        remote:{
                                                url: "/index.php/admin/index/checkuname",     //后台处理程序
                                                type: "post",               //数据发送方式
...
//                                        maxlength:'最多不能超过11位',
                ...
                $.post('/index.php/admin/index/douseradd',data,function(res){
                    alert(res);
                });
                });
        });
